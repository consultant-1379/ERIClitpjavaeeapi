...
import unittest
from javaee_extension.javaeeextension import JavaEEExtension


class TestJavaEEExtension(unittest.TestCase):

    def setUp(self):
        self.ext = JavaEEExtension()
...
#        self.assertEquals(prop_types_expected, prop_types)
    ...
    def test_item_types_registered(self):
        ...
        # are defined.
        item_types_expected = ['jboss-container',]
